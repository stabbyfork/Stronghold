...
import dpm_unsetup from './commands/dpm/unsetup.js';
...
import ranking_groups_list from './commands/ranking/groups/list.js';
import ranking_groups_create from './commands/ranking/groups/create.js';
import ranking_groups_delete from './commands/ranking/groups/delete.js';
...
import ranking_prefix_add from './commands/ranking/prefix/add.js';
import ranking_prefix_remove from './commands/ranking/prefix/remove.js';
import ranking_prefix_list from './commands/ranking/prefix/list.js';
...
ranking: {
  ...
  groups: {
    list: ranking_groups_list,
    create: ranking_groups_create,
  ...
  prefix: {
    add: ranking_prefix_add,
    remove: ranking_prefix_remove,
    list: ranking_prefix_list
  }
},
rbx: {
  blacklist: {
